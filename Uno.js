...
const player2HandDom = document.querySelector('.player-hand')

const cpuScoreDom = document.querySelector('#cpu-score')
const playerScoreDom = document.querySelector('#player-score')
const player2ScoreDom = document.querySelector('#player-score')
...
const player2Uno = document.querySelector('.player-animation')
